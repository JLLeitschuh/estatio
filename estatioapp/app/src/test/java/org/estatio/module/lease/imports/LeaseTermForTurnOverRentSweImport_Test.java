...
public class LeaseTermForTurnOverRentSweImport_Test {
    ...
    public void updateOrCreateTerm_works_for_new_term() throws Exception {
        ...
        LeaseItem leaseItem = new LeaseItem(){
            ...
            public LeaseTerm newTerm(final LocalDate startDate, final LocalDate endDate){
                leaseTermForTurnoverRent.setStartDate(startDate);
                leaseTermForTurnoverRent.setEndDate(endDate);
                return leaseTermForTurnoverRent;
            }
        };
        ...
        BigDecimal percentage = new BigDecimal("7.89");
        ...
        // when
        importLine.updateOrCreateTermWithManualValueAndPercentage(leaseItem, startDate, endDate, value, percentage);

        // then
        assertThat(leaseTermForTurnoverRent.getManualTurnoverRent()).isEqualTo(value);
        assertThat(leaseTermForTurnoverRent.getTurnoverRentRule()).isEqualTo("7.89");
    ...
    @Test
    public void updateOrCreateTerm_works_for_new_term_value_only() throws Exception {
        ...
        // when
        importLine.updateOrCreateTermWithManualValueAndPercentage(leaseItem, startDate, endDate, value, null);

        // then
        assertThat(leaseTermForTurnoverRent.getManualTurnoverRent()).isEqualTo(value);
        assertThat(leaseTermForTurnoverRent.getTurnoverRentRule()).isNull();
        assertThat(leaseTermForTurnoverRent.getStartDate()).isEqualTo(startDate);
        assertThat(leaseTermForTurnoverRent.getEndDate()).isEqualTo(endDate);
        assertThat(leaseTermForTurnoverRent.getStatus()).isEqualTo(LeaseTermStatus.APPROVED);
    }
    ...
    @Test
    public void updateOrCreateTerm_works_for_new_term_percentage_only() throws Exception {
        ...
        // when
        importLine.updateOrCreateTermWithManualValueAndPercentage(leaseItem, startDate, endDate, null, percentage);

        // then
        assertThat(leaseTermForTurnoverRent.getManualTurnoverRent()).isNull();
        assertThat(leaseTermForTurnoverRent.getTurnoverRentRule()).isEqualTo("7.89");
        assertThat(leaseTermForTurnoverRent.getStartDate()).isEqualTo(startDate);
        assertThat(leaseTermForTurnoverRent.getEndDate()).isEqualTo(endDate);
        assertThat(leaseTermForTurnoverRent.getStatus()).isEqualTo(LeaseTermStatus.APPROVED);
    ...
    @Test
    public void updateOrCreateTerm_works_for_existing_term_value_only() throws Exception {
    ...
    @Test
    public void updateOrCreateTerm_works_for_existing_term_percentage_only() throws Exception {
    ...
    public void updateOrCreateTerm_works_with_zero_value() throws Exception {
        ...
        // when
        importLine.updateOrCreateTermWithManualValueAndPercentage(leaseItem, startDate, null, new BigDecimal("0.00"), null);
    ...
    public void update_works_when_term_found() throws Exception {
        ...
        // when
        importLine.updateTermManualValueAndPercentage(leaseItem, startDate, endDate, value, percentage);
    ...
    public void update_works_when_term_NOT_found() throws Exception {
        ...
        // when
        importLine.updateTermManualValueAndPercentage(leaseItem, startDate, null, null, null);
    }
    ...
    @Test
    public void convertToTurnoverRentRule_test() throws Exception {

        LeaseTermForTurnOverRentSweImport imp = new LeaseTermForTurnOverRentSweImport();

        assertThat(imp.convertToTurnoverRentRule(new BigDecimal("1"))).isEqualTo("1");
        assertThat(imp.convertToTurnoverRentRule(new BigDecimal("1.1"))).isEqualTo("1.1");
        assertThat(imp.convertToTurnoverRentRule(new BigDecimal("1.11"))).isEqualTo("1.11");
