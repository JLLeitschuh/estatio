...
public class LeaseTermForTurnoverRentSweImportManager_Test {
    ...
    public void getTurnoverRentLines_when_endate_previous_on_end_of_year_or_empty_works() throws Exception {
        ...
        final String turnoverRentRulePreviousYear = "1.23";
        term1.setManualTurnoverRent(valuePreviousYear);
        term1.setTurnoverRentRule(turnoverRentRulePreviousYear);
        ...
        // then
        assertThat(turnoverRentLines).hasSize(2);
        LeaseTermForTurnOverRentSweImport line1 = turnoverRentLines.get(0);
        assertThat(line1.getValuePreviousYear()).isEqualTo(valuePreviousYear);
        assertThat(line1.getPercentagePreviousYear()).isEqualTo(new BigDecimal(turnoverRentRulePreviousYear));
        assertThat(line1.getStartDatePreviousYear()).isEqualTo(startDatePrevious);
        assertThat(line1.getEndDatePreviousYear()).isEqualTo(endDatePrevious);
        assertThat(line1.getValue()).isNull();
        assertThat(line1.getStartDate()).isEqualTo(new LocalDate(2018,1,1));
        assertThat(line1.getEndDate()).isEqualTo(new LocalDate(2018,12,31));
        LeaseTermForTurnOverRentSweImport line2 = turnoverRentLines.get(1);
        assertThat(line2.getValuePreviousYear()).isNull();
        assertThat(line2.getPercentagePreviousYear()).isNull();
        assertThat(line2.getStartDate()).isEqualTo(new LocalDate(2018,1,1));
        assertThat(line2.getEndDate()).isEqualTo(new LocalDate(2018,12,31));
    ...
    public void getTurnoverRentLines_when_endate_previous_before_end_of_year_works() throws Exception {
        ...
        previousTerm.setTurnoverRentRule(turnoverRentRulePreviousYear);
        ...
        // then
        assertThat(turnoverRentLines).hasSize(1);
        LeaseTermForTurnOverRentSweImport line = turnoverRentLines.get(0);
        assertThat(line.getValuePreviousYear()).isEqualTo(valuePreviousYear);
        assertThat(line.getPercentagePreviousYear()).isEqualTo(new BigDecimal(turnoverRentRulePreviousYear));
        assertThat(line.getStartDatePreviousYear()).isEqualTo(startDatePrevious);
        assertThat(line.getEndDatePreviousYear()).isEqualTo(endDatePrevious);
        assertThat(line.getValue()).isNull();
        assertThat(line.getPercentage()).isNull();
        assertThat(line.getStartDate()).isEqualTo(new LocalDate(2018,1,1));
        assertThat(line.getEndDate()).isEqualTo(new LocalDate(2018,12,31));
    }
    ...
    public void getTurnoverRentLines_when_endate_previous_after_end_of_year_works() throws Exception {
        ...
        assertThat(line.getValue()).isNull();
        assertThat(line.getPercentage()).isNull();
        assertThat(line.getStartDate()).isEqualTo(new LocalDate(2018,1,2));
        assertThat(line.getEndDate()).isEqualTo(new LocalDate(2018,12,31));
    }
    ...
    public void getTurnoverRentLines_makes_overlapping_terms_visible() throws Exception {
        ...
        final String turnoverRentRuleCurrentYear = "2.34";
        currentTerm.setManualTurnoverRent(valueCurrentYear);
        currentTerm.setTurnoverRentRule(turnoverRentRuleCurrentYear);
        ...
        assertThat(line.getStartDatePreviousYear()).isEqualTo(startDatePrevious);
        assertThat(line.getEndDatePreviousYear()).isEqualTo(endDatePrevious);
        assertThat(line.getValue()).isEqualTo(valueCurrentYear);
        assertThat(line.getPercentage()).isEqualTo(new BigDecimal(turnoverRentRuleCurrentYear));
        assertThat(line.getStartDate()).isEqualTo(startDateCurrentTerm);
        assertThat(line.getEndDate()).isEqualTo(endDateCurrentTerm);
    }

    @Test
    public void percentageFromTurnoverRentRule_test() throws Exception {

        LeaseTermForTurnoverRentSweImportManager manager = new LeaseTermForTurnoverRentSweImportManager();
        assertThat(manager.percentageFromTurnoverRentRule("7")).isEqualTo(new BigDecimal("7"));
        assertThat(manager.percentageFromTurnoverRentRule("7.12")).isEqualTo(new BigDecimal("7.12"));
        assertThat(manager.percentageFromTurnoverRentRule("7.12;")).isEqualTo(new BigDecimal("7.12"));
        assertThat(manager.percentageFromTurnoverRentRule("7.12;12345;")).isEqualTo(new BigDecimal("7.12"));
        assertThat(manager.percentageFromTurnoverRentRule("7.12;12345;9.12")).isEqualTo(new BigDecimal("7.12"));
